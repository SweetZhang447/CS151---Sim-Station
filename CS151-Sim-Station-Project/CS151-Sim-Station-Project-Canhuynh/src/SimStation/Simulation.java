...
public class Simulation extends Model {
    ...
    public void Start() {
        ...
        for (Agent a : agentsLists) {
            ...
            a.start(); // this breaks the code, but we're basically not like
            // even starting anything for the agents? - Sweet
        }
        startTimer();
        // Added firePropertyChange to every method in order for
        // the squares to show up, might need to change the
        // property change method in simStationView - Sweet
